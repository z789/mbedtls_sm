...
static int sm4_crypt_cfb128_wrap(void *ctx, mbedtls_operation_t operation,
                                  ...
                                  const unsigned char *input, unsigned char *output)
{
    return mbedtls_sm4_crypt_cfb128((mbedtls_sm4_context *) ctx, operation, length,
                                     iv_off, iv, input, output);
}
#endif /* MBEDTLS_CIPHER_MODE_CFB */
...
static const mbedtls_cipher_info_t sm4_128_ccm_star_no_tag_info = {
    MBEDTLS_CIPHER_SM4_128_CCM_STAR_NO_TAG,
    MBEDTLS_MODE_CCM_STAR_NO_TAG,
    128,
    "SM4-128-CCM*-NO-TAG",
    12,
...
const mbedtls_cipher_definition_t mbedtls_cipher_definitions[] =
{
    ...
    { MBEDTLS_CIPHER_SM4_128_CCM_STAR_NO_TAG,     &sm4_128_ccm_star_no_tag_info },
#endif
#endif /* MBEDTLS_SM4_C */
